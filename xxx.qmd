...
```{r}
freq_last_question[, c("Derniere question", "Effectif", "Proportion", "Question d'abandon")] %>%
  gt()
...
```{r}
freq_last_question[, c("Derniere question", "Effectif", "Proportion", "Question d'abandon")] %>%
  kable(caption = "Table des questions où les étudiant.es ont le plus abandonné la complétion (n = 901)") %>%
